    ...
    return (
        ...
        >
            ...
            <Marker 
                ...
                <Popup>
                    <div>
                        <b><h1>{station.name}</h1></b>
                        <h3>{station.address}</h3>
                        <h3>{station.city} {station.state} {station.zip}</h3>
                        <h3>{station.phone ? station.phone : "No contact info"}</h3>
                        <h3>{"$"+station.base_price + " to start charging process"}</h3>
                        <h3>{"$"+station.usage_price+"/kwh"}</h3>
                        <h3>{"Estimated charge cost: $"+station.price_to_charge}</h3>
                    </div>
                </Popup>
            </Marker>))
            }
